...
5. Download `Z.I.S.S. V1.0.zip` from [Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/181971), extract, and place the `.wabbajack` file into the Wabbajack folder you made in step 1 (e.g. `C:\Wabbajack`). Double click the `.wabbajack` file to start installation.
...
8. Set your installation folder to the folder you made in step 3 *(e.g. "C:\ZISS")*<br>
    ...
    > *You may need to click over to the "Log Viewer" tab and then back to the "Read Me" tab to view the Read Me file*
